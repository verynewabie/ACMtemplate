![image-20221119100524926](https://cartoonwqy.oss-cn-nanjing.aliyuncs.com/boke/202211191005016.png)

```cpp
int n, m;
struct Data{//s代表个数，因为我们把相同的Data合并比较好处理，res就代表有多少个数在三个维度上都小于等于该变量
    int a, b, c, s, res;
...
void merge_sort(int l, int r){
    ...
    int i = l, j = mid + 1, k = 0;
    //计算l~mid和mid+1~r之间有多少满足b，c都小于等于的数对，这时l~mid的a都一定小于mid+1~r了
    while (i <= mid && j <= r)
